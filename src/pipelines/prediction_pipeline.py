...
class PredictionPipeline:
    ...
    def predict(self,features):
        try:
            ...
            preprocessor=self.utils.load_object(self.predection_pipeline_config.preprocessor_path)
    ...
    def get_predicted_dataframe(self,input_dataframe_path:pd.DataFrame):
        try:
            ...
            os.makedirs(self.predection_pipeline_config.prediction_output_dirname,exist_ok=True)
            input_dataframe.to_csv(self.predection_pipeline_config.prediction_file_path,index=False)
